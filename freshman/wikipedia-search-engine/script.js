const form = document.querySelector('.js-search-form'); //get instance of .js-search-form-input
form.addEventListener('submit',handleSubmit); //handle submit...pressing enter key
